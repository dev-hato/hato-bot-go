...
# アプリケーションをビルド
RUN CGO_ENABLED=0 GOOS=linux go build -a -installsuffix cgo -o hato-bot-go cmd/misskey_bot/main.go
RUN CGO_ENABLED=0 GOOS=linux go build -a -installsuffix cgo -o health-check cmd/health_check/main.go
